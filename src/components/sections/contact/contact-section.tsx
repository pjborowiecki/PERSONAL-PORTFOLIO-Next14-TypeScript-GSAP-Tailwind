...
export function ContactSection() {
  return (
    <section
      ...
      className="mx-auto grid w-full max-w-[2560px] grid-cols-1 gap-[7.6vw] pb-[24vw] pt-[12vw]"
    >
      <div className="mx-[2rem] hidden md:flex">
        <h2 className="text-[16.2vw] font-black leading-[86%]">
          Have some
          <span className="text-[14.8vw]"> great ideas?</span>
        </h2>
      </div>

      <div className="mx-[2rem] grid h-auto grid-cols-1 gap-[12.8vw] md:grid-cols-2 md:gap-[4.4vw]">
        <div className="flex w-full flex-col gap-[12.8vw] md:gap-[3.8vw]">
          <div className="flex flex-col gap-[9.6vw]">
            ...
            <h3 className="text-[11.9vw] font-semibold leading-[110%] tracking-tight md:text-[6.1vw]">
              Let&apos;s
          ...
          <p className="text-[6.8vw] leading-[150%] text-muted-foreground md:text-[3.4vw] md:leading-[120%]">
