    ...
    >
      ...
      <div className="flex items-center gap-8 md:pr-6">
        ...
        <div className="flex h-full items-end">
          <Icons.arrowUpRight className="z-[1] hidden size-16 transition-all duration-500 ease-out md:group-hover:rotate-[585deg] md:group-hover:text-background lg:block" />
        </div>
      </div>
    </div>
  )
